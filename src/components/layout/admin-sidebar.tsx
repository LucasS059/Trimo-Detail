...
const styles = {
  sidebar: "hidden md:flex flex-col w-64 h-full bg-zinc-950 border-r border-zinc-900 shrink-0",
  header: "h-20 flex items-center px-6 border-b border-zinc-900 shrink-0",
  logo: "font-black text-xl tracking-tighter text-white",
  logoDot: "text-[#E56B25]",
  nav: "flex-1 px-4 py-6 space-y-1.5 overflow-y-auto",

  // Design Inativo vs Ativo com o Cobre Vivido
  linkDefault: "flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-zinc-400 hover:text-white hover:bg-zinc-900 transition-colors",
  linkActive: "flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-bold text-[#E56B25] bg-[#E56B25]/10 transition-colors",

  footer: "p-4 border-t border-zinc-900 shrink-0",
  btnLogout: "w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-zinc-400 hover:text-red-400 hover:bg-red-500/10 transition-colors cursor-pointer disabled:opacity-50",
};